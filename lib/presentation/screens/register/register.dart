              ...
              builder: (context, state) {
                return
                          CommonButton(
                            ...
                            onTap: () {
                              if (state is RegisterClickedState && state.isLoading == true) {
                                
                              } else{
                                 if (_formKey.currentState!.validate()) {
                                  if (addedTreatments.value.isEmpty) {
                                    HelperService.showCustomToast(message: "Atleast one treatment should be selected.",type: "error");
                                  } else{
